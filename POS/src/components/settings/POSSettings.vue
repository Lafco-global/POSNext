...
const settingsResource = createResource({
	url: "pos_next.pos_next.doctype.pos_next_settings.pos_next_settings.get_pos_settings",
	makeParams() {
		return {
			pos_profile: props.posProfile,
		};
...
async function saveSettings() {
	...
	try {
		...
		const result = await call(
			"pos_next.pos_next.doctype.pos_next_settings.pos_next_settings.update_pos_settings",
			{
				pos_profile: props.posProfile,
