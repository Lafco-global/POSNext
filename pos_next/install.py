...
def after_migrate():
	...
	try:
		# LAF-117: do NOT run reclaim_pos_settings_doctype. We rename our DocType
		# to "POS Next Settings" via pre_model_sync patch, so the name "POS Settings"
		# is intentionally left to ERPNext v16's Single. Reclaim would undo that.
